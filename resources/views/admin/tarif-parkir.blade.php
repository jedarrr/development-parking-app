    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-blue-600 text-white flex flex-col justify-between p-6">
            <div>
                ...
                <nav class="space-y-2">
                    ...
                    <!-- Menu Tarif Parkir Aktif -->
                    <a href="{{ route('halaman.tarif-parkir') }}" class="flex items-center space-x-3 bg-blue-700 px-4 py-3 rounded-lg text-white font-medium shadow-sm">
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <header class="flex justify-between items-center bg-white px-8 py-5 border-b border-gray-200">
                <h2 class="text-2xl font-bold text-gray-800">Tarif Parkir</h2>
                        ...
                        <table class="w-full text-left text-sm border-collapse">
                            <thead>
                                <tr class="text-gray-600 border-b border-gray-200">
                                    ...
                                    <th class="py-4 px-4 font-semibold">Jenis Kendaraan</th>
                                    <th class="py-4 px-4 font-semibold">Tarif Awal</th>
                                    <th class="py-4 px-4 font-semibold">Tarif Per Jam</th>
                                    <th class="py-4 px-4 font-semibold">Tarif Maksimal</th>
                            ...
                            <tbody class="divide-y divide-gray-100 text-gray-700">
                                ...
                                <tr class="hover:bg-gray-50/50 transition">
                                    ...
                                    <td class="py-4 px-4 font-medium text-gray-800">Motor</td>
                                    <td class="py-4 px-4">Rp. 2.000</td>
                                    <td class="py-4 px-4">Rp. 1.000</td>
                                    <td class="py-4 px-4">Rp. 10.000</td>
                                    <td class="py-4 px-4">
                                ...
                                <tr class="hover:bg-gray-50/50 transition">
                                    ...
                                    <td class="py-4 px-4 font-medium text-gray-800">Mobil</td>
                                    <td class="py-4 px-4">Rp. 5.000</td>
                                    <td class="py-4 px-4">Rp. 2.000</td>
                                    <td class="py-4 px-4">Rp. 20.000</td>
                                    <td class="py-4 px-4">
                                        <div class="flex items-center justify-center space-x-2">
                                            <button class="w-8 h-8 rounded-lg border border-blue-200 text-blue-600 hover:bg-blue-50 flex items-center justify-center transition">
                                                <i class="fas fa-pencil-alt text-xs"></i>
