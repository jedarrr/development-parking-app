    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-blue-600 text-white flex flex-col justify-between p-6">
            <div>
                ...
                <!-- Navigasi Menu -->
                <nav class="space-y-2">
                    <a href="{{ route('halaman.owner') }}" class="flex items-center space-x-3 text-blue-100 hover:bg-blue-700 px-4 py-3 rounded-lg font-medium transition">
                        <i class="fas fa-home w-5"></i>
                        <span>Home</span>
                    </a>
                    
                    <!-- Menu Rekap Transaksi Aktif -->
                    <a href="{{ route('halaman.rekap-transaksi') }}" class="flex items-center space-x-3 bg-blue-700 px-4 py-3 rounded-lg text-white font-medium shadow-sm">
